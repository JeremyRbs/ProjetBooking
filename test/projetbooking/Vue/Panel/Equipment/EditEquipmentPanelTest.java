 ...
 * @author Jerem
 */
public class EditEquipmentPanelTest {
    
    public EditEquipmentPanelTest() {
    }
    ...
    /**
     * Test of ajouterEcouteurBouton method, of class EditEquipmentPanel.
    ...
    public void testAjouterEcouteurBouton() throws SQLException {
        ...
        EditEquipmentPanel instance = new EditEquipmentPanel();
