 ...
 * @author Jerem
 */
public class AdminBookingPanelTest {
    
    public AdminBookingPanelTest() {
    }
    ...
    /**
     * Test of ajouterEcouteurBouton method, of class AdminBookingPanel.
    ...
    public void testAjouterEcouteurBouton() throws SQLException {
        ...
        AdminBookingPanel instance = new AdminBookingPanel();
